...
# BEGIN COPIED TEST FILE: tests/test_hosvd_5d.py
# import pytest
#
# import numpy as np
#
...
#     benchmark = hosvd_5d.HOSVD5DBenchmark()
#     prev_xp = getattr(hosvd_5d, "xp", None)
#     hosvd_5d.xp = xp_numpy
#     try:
...
#     """
#     problem = hosvd_5d.HOSVD5DDenseGenerator().generate(
#         hosvd_5d.HOSVD5DDenseGenerator().datasets[0]
#     )
#     data = problem.inputs
#     meta = problem.meta
...
#     """
#     problem = hosvd_5d.HOSVD5DSparseGenerator().generate(
#         hosvd_5d.HOSVD5DSparseGenerator().datasets[0]
#     )
#     data = problem.inputs
#     meta = problem.meta
#     X_bin, ranks_bin = data
...
# END COPIED TEST FILE: tests/test_hosvd_5d.py
