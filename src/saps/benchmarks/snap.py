"""Shared SuiteSparse SNAP matrices for graph benchmarks."""
...
# Counts describe the published SNAP source, not necessarily the stored matrix.
# fmt: off
...
_GRAPHS = [
    ...
    SNAPDataset("soc-Slashdot0902", ["Social networks"], ["Directed"], 82168, 948464, "Slashdot social network from February 2009"),
    ...
    SNAPDataset("as-735", ["Autonomous systems graphs"], ["Undirected"], "103-6,474", "243-13,233", "733 daily instances(graphs) from November 8 1997 to January 2 2000"),
...
class SNAPGraphGenerator(Generator[SNAPDataset]):
    ...
    @property
    def description(self) -> str:
        return "Shared SNAP adjacency matrices from the SuiteSparse Matrix Collection."
...
def select_source_vertices(
    ...
    edges. Returned IDs index the adjacency matrix.
