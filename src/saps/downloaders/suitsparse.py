...
# LPnetlib spells an infinite variable bound as a very large finite number rather
# than an IEEE infinity, so bounds at or past this magnitude are treated as absent.
_INFINITE_BOUND = 1e30
