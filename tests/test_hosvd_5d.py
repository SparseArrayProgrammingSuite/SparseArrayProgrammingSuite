...
import sparseappbench.benchmarks.HOSVD_5d as hosvd_5d
...
def test_hosvd_dense_generator_reconstruction(xp_numpy):
    ...
    """
    data, meta = hosvd_5d.HOSVD5DDenseGenerator().generate(
...
def test_hosvd_sparse_input(xp_numpy):
    ...
    """
    data, meta = hosvd_5d.HOSVD5DSparseGenerator().generate(
